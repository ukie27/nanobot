...
from nanobot.career.domain.materials import (
    FactSnapshot,
    MaterialBlock,
...
from nanobot.career.infrastructure.database.profile_gateway import PROFILE_ID, VersionConflictError
    ...
    def save(self, *, context: dict[str, Any], draft: ResumeDraftResult,
        ...
        with self._session_factory() as session:
            ...
            ensure_review_task(
                ...
                summary=review.summary, source_type="nanobot_material_drafter_reviewer",
