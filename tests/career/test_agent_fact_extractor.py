...
from nanobot.career.application.services import ProfileApplicationService
...
from nanobot.career.infrastructure.database.migrations import upgrade_to_head
from nanobot.career.infrastructure.database.models import AgentRunModel, DocumentModel
from nanobot.career.infrastructure.database.profile_gateway import SqlAlchemyProfileGateway
from nanobot.career.infrastructure.extraction import LocalResumeFactExtractor
from nanobot.career.infrastructure.files import DocumentParser, LocalBlobStore
...
def test_agent_extractor_has_no_tools_and_validates_evidence() -> None:
    ...
    extractor = NanobotProfileFactExtractor(provider)  # type: ignore[arg-type]
