...
from career_console.domain.mail import classification_from_text
...
from career_console.infrastructure.mail import (
    ImapReadOnlyError,
...
def test_api_config_sync_cursor_and_message_center_without_secret_leak(tmp_path: Path) -> None:
    ...
    with TestClient(create_app(settings)) as client:
        ...
        assert stored.startswith("career-console:")
        assert stored.endswith(":connector:imap:password")
