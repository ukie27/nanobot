...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        from career_console.runtime.bus.events import InboundMessage
        from career_console.runtime.command.builtin import cmd_stop
        from career_console.runtime.command.router import CommandContext
...
class TestDispatch:
    def test_exec_tool_not_registered_when_disabled(self):
        from career_console.runtime.config.schema import ExecToolConfig
