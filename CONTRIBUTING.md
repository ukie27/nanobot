# Contributing to CareerConsole

Thank you for being here.

CareerConsole is built with a simple belief: good tools should feel calm, clear, and humane.
...
git clone https://github.com/HKUDS/career_console.runtime.git
cd CareerConsole
...
# Lint code
ruff check career_console/runtime/

# Format code
ruff format career_console/runtime/
```

## Code Style

We care about more than passing lint. We want CareerConsole to stay small, calm, and readable.
...
Please feel free to open an [issue](https://github.com/HKUDS/career_console/runtime/issues), join the community, or simply reach out:

- [Discord](https://discord.gg/MnCvHqpUGB)
- [Feishu/WeChat](./COMMUNICATION.md)
- Email: Xubin Ren (@Re-bin) — <xubinrencs@gmail.com>

Thank you for spending your time and care on career_console.runtime. We would love for more people to participate in this community, and we genuinely welcome contributions of all sizes.
