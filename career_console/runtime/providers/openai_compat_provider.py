...
from career_console.runtime.providers.base import LLMProvider, LLMResponse, ToolCallRequest

if TYPE_CHECKING:
    from career_console.runtime.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "X-OpenRouter-Title": "CareerConsole",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply CareerConsole attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
    ...
    async def chat_stream(
        ...
        idle_timeout_s = int(
            os.environ.get("CAREER_CONSOLE_STREAM_IDLE_TIMEOUT_S", "90")
        )
        try:
