...
TOKEN_APP_NAME = "CareerConsole"
USER_AGENT = "career_console/runtime/0.1"
...
class GitHubCopilotProvider(OpenAICompatProvider):
    ...
    async def _get_copilot_access_token(self) -> str:
        ...
        if not github_token or not github_token.access:
            raise RuntimeError("GitHub Copilot is not logged in. Run: career-console provider login github-copilot")
