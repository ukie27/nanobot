"""Utility functions for career_console.runtime."""
...
_TOOL_RESULTS_DIR = ".career-console/tool-results"
...
def build_status_content(
    *,
    ...
    return "\n".join([
        f"\U0001f408 CareerConsole v{version}",
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        tpl = pkg_files("career_console.runtime") / "templates"
    except Exception:
        return []
    if not tpl.is_dir():
        return []
