...
RESTART_NOTIFY_CHANNEL_ENV = "CAREER_CONSOLE_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "CAREER_CONSOLE_RESTART_NOTIFY_CHAT_ID"
RESTART_STARTED_AT_ENV = "CAREER_CONSOLE_RESTART_STARTED_AT"
