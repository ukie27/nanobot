...
from career_console.runtime.agent.tools.confirm import ConfirmManager, ConfirmResult
...
class ExecTool(Tool):
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        from career_console.runtime.security.network import contains_internal_url
        ...
        if self.restrict_to_workspace:
            ...
            for raw in self._extract_absolute_paths(cmd):
                ...
                try:
                    media_path = get_media_dir(create=False).resolve()
                except TypeError:  # compatibility with injected path providers
