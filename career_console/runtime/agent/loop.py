...
from career_console.runtime.agent.memory import MemoryConsolidator
from career_console.runtime.agent.runner import AgentRunner, AgentRunSpec
from career_console.runtime.agent.skills import BUILTIN_SKILLS_DIR
from career_console.runtime.agent.subagent import SubagentManager
from career_console.runtime.agent.tools.confirm import ConfirmManager
...
from career_console.runtime.agent.tools.message import MessageTool
...
# from career_console.runtime.agent.tools.exec_tool import ExecTool
from career_console.runtime.agent.tools.spawn import SpawnTool
from career_console.runtime.agent.tools.web import WebFetchTool, WebSearchTool
...
from career_console.runtime.command import CommandContext, CommandRouter, register_builtin_commands
...
from career_console.runtime.session.manager import Session, SessionManager
from career_console.runtime.utils.helpers import image_placeholder_text, truncate_text
from career_console.runtime.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from career_console.runtime.config.schema import (
        ChannelsConfig,
        ExecToolConfig,
        WebToolsConfig,
    )
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from career_console.runtime.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        # CAREER_CONSOLE_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("CAREER_CONSOLE_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from career_console.runtime.agent.tools.mcp import connect_mcp_servers
        try:
