...
class BaseChannel(ABC):
    ...
    to integrate with the CareerConsole message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        if not self.transcription_api_key:
            return ""
        try:
            from career_console.runtime.providers.transcription import GroqTranscriptionProvider
    ...
    def default_config(cls) -> dict[str, Any]:
        """Return defaults for configuration-center and host integrations."""
