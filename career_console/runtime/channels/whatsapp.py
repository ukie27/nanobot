...
class WhatsAppChannel(BaseChannel):
    ...
    async def login(self, force: bool = False) -> bool:
        ...
        """
        from career_console.runtime.config.paths import get_runtime_subdir
...
def _ensure_bridge_setup() -> Path:
    ...
    """
    from career_console.runtime.config.paths import get_bridge_install_dir
    ...
    src_bridge = current_file.resolve().parents[3] / "integrations" / "whatsapp-bridge"
    ...
    if not source:
        raise RuntimeError(
            ...
            "Try reinstalling: pip install --force-reinstall career-console"
        )
