...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install career-console[matrix]"
    ) from e
...
from career_console.runtime.config.paths import get_data_dir, get_media_dir
from career_console.runtime.config.schema import Base
from career_console.runtime.utils.helpers import safe_filename
