...
from career_console.runtime.command.builtin import build_help_text
from career_console.runtime.config.paths import get_media_dir
from career_console.runtime.config.schema import Base
from career_console.runtime.utils.helpers import safe_filename, split_message
...
if DISCORD_AVAILABLE:
    ...
    class DiscordBotClient(discord.Client):
        ...
        async def send_outbound(self, msg: OutboundMessage) -> None:
            """Send a CareerConsole outbound message using Discord transport rules."""
...
class DiscordChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not DISCORD_AVAILABLE:
            logger.error("discord.py not installed. Run: pip install career-console[discord]")
            return
